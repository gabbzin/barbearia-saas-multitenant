...
**Arquivo:** `shared/actions/create-booking.ts`  
**Linha:** 42-49
...
**Arquivo:** `shared/actions/cancel-booking.ts`  
**Linha:** 42-49
...
**Arquivo:** `shared/components/cancel-booking.tsx`  
**Linha:** 66
...
**Arquivo:** `shared/actions/get-date-available-time-slots.ts`  
**Linha:** 40-47
...
**Arquivo:** `shared/components/search-input.tsx`
